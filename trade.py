...
class LoginForm(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.forgotPassword = customtkinter.CTkLabel(self, text="Nie masz jeszcze konta?", font=("Roboto", 12), fg_color="transparent", width=150, height=20)
        self.forgotPassword.grid(row=4, column=0,padx=20,pady=5, sticky=tk.W)

        self.forgotPassword = customtkinter.CTkButton(self, text="Zarejestruj się?", font=("Roboto", 12), fg_color="transparent", width=150, height=20, text_color="#0DCB81", hover="disable")
